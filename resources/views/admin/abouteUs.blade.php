        ...
        <div class="w-full">
            <div >
              ...
              <div class="mt-5 md:mt-0 md:col-span-2">
                <form action="{{route('aboute.admin.edit',1)}}" method="POST">
                    @csrf
                  <div class="shadow sm:rounded-md sm:overflow-hidden">
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                      ...
                      <div>
                        <label for="body" class="block text-sm font-medium text-gray-700"> درباره ما </label>
                        <div class="mt-1">
                          <textarea id="body" name="body" rows="24" class="shadow-sm  focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="شروع کن">{{old('body',$body)}}</textarea>
                        </div>
                        <p class="mt-2 text-sm text-gray-500">توضیحات درباره من</p>
                        <div class="my-1">
                            <label for="link" class="block text-sm font-medium text-gray-700"> لینک ها </label>
                            <input type="text" id="link" name="link" class="shadow-sm  focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" value="{{old('link',$links)}}">
                        </div>
                      </div>
